...
# delta-changes between historical and projected CMIP5 data.
# This code runs on two R libraries; fileds and R.matlab
# Author - Akila Harishchandra
...
# IPCC delta values in .mat format
ipcc<-readMat('')
# Contemporary SST climatology in .mat format
clim<-readMat('')
...
# Change the file name before saving (.mat format)
 writeMat("",mmeansst= final.matrix)
